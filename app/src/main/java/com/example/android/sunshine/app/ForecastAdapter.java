...
public class ForecastAdapter extends CursorAdapter{
    ...
    private String convertCursorRowToUXFormat(Cursor cursor){
        ...
        int idx_min_temp = cursor.getColumnIndex(COLUMN_MIN_TEMP);
        int idx_date = cursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DATE);
        int idx_short_desc = cursor.getColumnIndex(COLUMN_SHORT_DESC);
    ...
    // This is where we fill in the views with the contents fo the cursor
    @Override
